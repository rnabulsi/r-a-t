...
void TestNodeBinarySearch::testConstruction() {
...
void TestNodeBinarySearch::testHasChildren() {
...
void TestNodeBinarySearch::testAddRawChild() {
...
void TestNodeBinarySearch::testAddSharedPointerChild() {
...
void TestNodeBinarySearch::testRemoveChildren() {
    Node *parent = new Node();
